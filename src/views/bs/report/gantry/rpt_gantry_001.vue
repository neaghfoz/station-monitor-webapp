...
export default {
  name: 'bs.report.gantry.rpt_gantry_001',
  components: {TiSelect, TiSelectTree, TiDateRange, tiSysOrg, TiDateRangeDivide, TiSysGantry},
  mixins: [...mixin],
  data() {
    return {
      reportUrl: '',
      urlprefix: '/webroot/decision/view/report?viewlet=gantry/rpt_gantry_001_01_门架车流量通行报表.cpt',
      queryParams: {
        reportCode: 'gantry_001',
        statType: 'subTotal',
