...
<script>
  ...
  export default {
    name: 'bs.report.gantry.rpt_gantry_002',
    components: {TiSelect, TiSelectTree, TiDateRange, tiSysOrg, TiDateRangeDivide, TiSysGantry},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=gantry/rpt_gantry_002_01_门架车种车流量报表.cpt',
        queryParams: {
          reportCode: 'gantry_002',
          statType: 'subTotal',
