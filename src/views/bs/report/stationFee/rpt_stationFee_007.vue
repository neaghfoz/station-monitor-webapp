...
<script>
  ...
  export default {
    name: 'bs.report.stationFee.rpt_stationFee_007',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFee/rpt_stationFee_007_01_分车型车流量通行费比例报表(拆分前).cpt',
        queryParams: {
          reportCode: 'stationFee_007',
