...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_001',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_001_01_分站分车型车流量报表.cpt',
        queryParams: {
          reportCode: 'stationFlow_001',
          inOutType: '2',
          statType: 'subTotal',
