...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_002',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_002_01_分站分广场车流量报表(拆分前).cpt',
        queryParams: {
          reportCode: 'stationFlow_002',
          inOutType: '2',
          statType: 'subTotal',
