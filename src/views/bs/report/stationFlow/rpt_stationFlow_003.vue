  ...
  <div class="app-container" style="height: 100%">
    <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'"
      ...
      <el-form-item ref="elRowAll" style="margin-bottom:0">
        ...
        <el-form-item label="通行介质" prop="mediaTypeStr">
          <ti-select style="width:180px" multiple v-model="queryParams.mediaTypeStr"
                     dict-type="tibms_bs_report_mediaType"/>
        </el-form-item>
...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_003',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_003_01_分站分车种车流量报表(拆分前).cpt',
        queryParams: {
          reportCode: 'stationFlow_003',
          inOutType: '2',
          mediaTypeStr: '',
