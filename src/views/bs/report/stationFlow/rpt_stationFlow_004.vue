...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_004',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_004_01_分车型24小时车流量报表(拆分前).cpt',
        queryParams: {
          reportCode: 'stationFlow_004',
          inOutType: '2',
