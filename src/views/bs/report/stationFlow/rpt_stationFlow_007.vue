...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_007',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_007_01_分站分广场24小时车流量报表(拆分前).cpt',

        queryParams: {
          reportCode: 'stationFlow_007',
