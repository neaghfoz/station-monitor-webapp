...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_008',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_008_01_出入口车种车流量统计报表.cpt',
        queryParams: {
          reportCode: 'stationFlow_008',
