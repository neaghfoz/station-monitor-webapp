...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_009',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_009_01_出入口交通流量情况报表.cpt',
        queryParams: {
          reportCode: 'stationFlow_009',
