  ...
  <div class="app-container" style="height: 100%">
    <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'"
      ...
      <el-form-item label="工班"  prop="shiftIdStr">
        <ti-select v-model="queryParams.shiftIdStr" url="api/v1/common/squad/list" style="width: 150px"
                   :props="{key:'squadNo',value:'squadNo',label:'squadNameText'}" multiple :disabled=" queryParams.collectType !='squadDate'" />
      </el-form-item>
      ...
      <iframe v-bind:src="reportUrl" frameborder=0 border="0" style="overflow:auto;width: 100%;float: left;"
...
<script>
  ...
  export default {
    name: 'bs.report.stationFlow.rpt_stationFlow_011',
    components: {TiSelect, TiDateRange, tiSysOrg, TiDateRangeDivide},
    mixins: [...mixin],
    data() {
      return {
        reportUrl: '',
        urlprefix: '/webroot/decision/view/report?viewlet=stationFlow/rpt_stationFlow_011_01_客货专分车型车流量比例报表(拆分前).cpt',
        queryParams: {
          reportCode: 'stationFlow_011',
