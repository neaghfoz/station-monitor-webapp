<template>
  <div class="app-container"  style="height: 100%">
    ...
    <div class="container-fluid el-col-md-24">
      <p style="color: #606266;font-size: 14px;vertical-align: middle;    font-family: Helvetica Neue, Helvetica, PingFang SC, Hiragino Sans GB, Microsoft YaHei, Arial, sans-serif;" v-show="queryParams.showDefault=='table'">单位（元）</p>
...
<script>
  ...
  import tableOption from "@/views/cy/analyse/change/income/tableOption";
  import chartOption from "@/views/cy/analyse/change/income/chartOption";
  ...
  export default {
    name: "analyse.change.stationIncomeView",
    mixins: [...mixin],
    ...
    created() {
      this.queryParams.activeName = 'flow';
    ...
    methods:{
      ...
      export() {
        tableOption.export(this.$refs.appTable, '收入分析')
      },
      handleReset() {
