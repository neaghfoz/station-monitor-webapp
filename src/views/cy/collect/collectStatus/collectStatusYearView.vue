  ...
  <div class="app-container">
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        ...
        <el-form-item label="日期" prop="dates">
          <el-col :span="30">
              <el-form-item prop="startDate" v-show="false"/>
              ...
              <ti-date-range-divide date-style="width:200px" ref="year" :editable="false" v-model="queryParams"
                                    date-type="year"
                                    format="yyyy" value-format="yyyy" begin-key="startDate"
                                    end-key="endDate"/>
          </el-col>
        </el-form-item>

        <el-form-item label="状态" prop="statusStr">
          <ti-select v-model="queryParams.statusStr" :dict-type="statusDictType"  :clearable="false" multiple/>
        </el-form-item>
    ...
    >
      ...
      <template v-slot:operation="{ row }">
        ...
        <el-button v-permission="['collectStatus:edit2']" type="primary" v-show="hasPermission(row,'edit2')" @click="edit(row)">编辑</el-button>
...
<script>
  ...
  export default {
    name: 'cy.collect.collectStatus.year',
    mixins: [...mixin],
    ...
    data() {
      return {
        queryParams: {
          ...
          tableIdStr: '',
          statusStr: '',
          startDate: moment(new Date()).add(0, 'year').format('YYYY'),
          endDate: moment(new Date()).add(0, 'year').format('YYYY'),
          collectType: CollectConstant.type.year
        },
        constant: {
        ...
        columns: [
          ...
          {title: '填报年份', field: 'collectYear', minWidth: 100, showOverflow: true},
    ...
    methods: {
      hasPermission(row, opType) {
        ...
        switch (opType) {
          ...
          case 'add':
            ...
            break;
          case 'edit':
            flag = userOrgLevel != province && (rowStatus == status.edit || rowStatus == status.save);
            break;
          case 'edit2':
      ...
      async getCurUserOrg() {
        ...
        this.statusDictType = (this.userOrg.nodeLevel == province) ? 'tibms_cy_collect_provice_status':'tibms_cy_collect_road_status';
      ...
      async getData() {
        ...
        if (this.userOrg) {
          ...
          if(this.queryParams.startDate!=null && this.queryParams.startDate!=''){
            this.queryParams.startDate = this.queryParams.startDate.substring(0,4) + '-01-01';
          }
          if(this.queryParams.endDate!=null && this.queryParams.endDate!=''){
            this.queryParams.endDate = this.queryParams.endDate.substring(0,4) + '-12-30';
          }
        }
