      ...
      <el-form ref="searchForm"  :model="queryParams" inline :label-width="'100px'">
        ...
        <el-form-item prop="dates" label="日期">
          <el-col :span="30">
            ...
            <el-form-item v-show="queryParams.showDefault === 'chart'" prop="collectMonth">
              <ti-date v-model="queryParams.collectMonth" dateType="month" format="yyyy-MM" value-format="yyyy-MM"/>
            </el-form-item>
          </el-col>
        </el-form-item>
...
<script>
  ...
  export default {
    name: "collect.dataMonitor.dataMonitorDay.dataMonitorView",
    mixins: [...mixin],
    ...
    data() {
      return {
        queryParams:{
          ...
          collectMonth:moment(new Date()).format('YYYY-MM'),
          startDate: '',
          endDate: '',
          showDefault:'chart',
          sysOrgIdStr:''
    ...
    methods:{
      async getData() {
        ...
        if (this.queryParams.showDefault === 'table') {
          dateTrans = dateUtil.dateCombination(this.queryParams.startDay, this.queryParams.endDay, 'day');
        } else if (this.queryParams.showDefault === 'chart') {
          dateTrans = dateUtil.dateCombination(this.queryParams.collectMonth,
            this.queryParams.collectMonth, 'month');
        }
