...
<script>
  ...
  export default {
    name: 'report.basis.etcArtificialLaneActually',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'ETC走人工车道实得';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/ETC走人工车道实得.cpt',this.queryParams);
      }
    }
  }
</script>
