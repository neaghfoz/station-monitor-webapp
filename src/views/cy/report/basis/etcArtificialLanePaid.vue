...
<script>
  ...
  export default {
    name: 'report.basis.etcArtificialLanePaid',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'ETC走人工车道实收';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/ETC走人工车道实收.cpt',this.queryParams);
      }
    }
  }
</script>
