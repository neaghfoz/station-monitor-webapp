...
<script>
  ...
  export default {
    name: 'report.basis.etcDedicatedLaneActually',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'ETC专用车道实得';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/ETC专用车道实得.cpt',this.queryParams);
      }
    }
  }
</script>
