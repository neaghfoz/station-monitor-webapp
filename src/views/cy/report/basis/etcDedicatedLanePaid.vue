...
<script>
  ...
  export default {
    name: 'report.basis.etcDedicatedLanePaid',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'ETC专用车道实收';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/ETC专用车道实收.cpt',this.queryParams);
      }
    }
  }
</script>
