...
<script>
  ...
  export default {
    name: 'report.basis.gantryMtcActually',
      ...
      async getData() {
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.queryParams.fileName = '门架MTC实得';
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/门架MTC实得.cpt',this.queryParams);
          } else {
