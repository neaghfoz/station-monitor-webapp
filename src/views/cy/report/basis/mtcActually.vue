  ...
  export default {
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'MTC实得';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/MTC实得.cpt',this.queryParams);
      }
    }
  }
</script>
