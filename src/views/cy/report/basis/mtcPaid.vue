  ...
  export default {
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = 'MTC实收';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/MTC实收.cpt',this.queryParams);
      }
    }
  }
</script>
