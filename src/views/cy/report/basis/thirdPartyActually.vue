...
<script>
  ...
  export default {
    name: 'report.basis.thirdPartyActually',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = '第三方支付实得';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/basis/第三方支付实得.cpt',this.queryParams);
      }
    }
  }
</script>
