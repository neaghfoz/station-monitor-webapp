...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_001',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '绿色通道车辆情况表';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_001_01_绿色通道车辆情况表.cpt',this.queryParams);
      }
    }
  }
</script>
