...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_003',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '各收费站出口各类车收入较去年同期变化表';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_003_01_各收费站出口各类车收入较去年同期变化表.cpt',this.queryParams);
      }
    }
  }
</script>
