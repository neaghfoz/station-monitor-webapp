...
<script>
  ...
  import {datePrecision} from "@/views/cy/common/datePrecision/datePrecision";
  import reportUtil from "@/views/pro/report/common/reportUtil"

  export default {
    name: 'report.charge.rpt_charge_004',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '长益高速各类车流量收入比重对比表';
        this.queryParams.chartFileName = '长益高速各类车流量收入比重对比图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_004_01_长益高速各类车流量收入比重对比表.cpt',this.queryParams);
      }
    }
  }
</script>
