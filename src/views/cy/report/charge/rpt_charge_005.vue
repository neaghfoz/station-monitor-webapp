...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_005',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '高速免费车车流量表';
        this.queryParams.chartFileName = '高速公路免费车日均流量对比图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_005_01_高速免费车车流量表.cpt',this.queryParams);
      }
    }
  }
</script>
