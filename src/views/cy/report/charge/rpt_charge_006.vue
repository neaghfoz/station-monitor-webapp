...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_006',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '各站实征率对比表';
        this.queryParams.chartFileName = '各站实征率对比图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_006_01_各站实征率对比表.cpt',this.queryParams);
      }
    }
  }
</script>
