...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_007',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '各年度收费站收费车流量及收入对比表';
        this.queryParams.chartFlowFileName = '月度收费车辆流量比较图';
        this.queryParams.chartIncomeFileName = '月度路费收入比较图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_007_01_各年度收费站收费车流量及收入对比表.cpt',this.queryParams);
      }
    }
  }
</script>
