...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_008',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = 'ETC收费车及免费车流量月度对比表';
        this.queryParams.chartTollFileName = 'ETC收费车流量月度对比图';
        this.queryParams.chartFreeFileName = 'ETC免费车流量月度对比图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_008_01_ETC收费车及免费车流量月度对比表.cpt',this.queryParams);
      }
    }
  }
</script>
