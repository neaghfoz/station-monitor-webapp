...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_009',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '各站收费车流量情况表';
        this.queryParams.chartFileName = '各站流量对比图';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_009_01_各站收费车流量情况表.cpt',this.queryParams);
      }
    }
  }
</script>
