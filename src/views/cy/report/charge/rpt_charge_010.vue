...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_010',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '各收费站征费额情况';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/charge/rpt_charge_010_01_各收费站征费额情况.cpt',this.queryParams);
      }
    }
  }
</script>
