...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_011',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = '各收费站征费情况';
        //用户levelya
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/charge/rpt_charge_011_01_各收费站征费情况.cpt&__bypagesize__=false',
          this.queryParams);
