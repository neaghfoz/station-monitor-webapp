...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_013',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = '相关收费指标对比表';
        //用户levelya
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/charge/rpt_charge_013_01_相关收费指标对比表.cpt&__bypagesize__=false',
          this.queryParams);
