...
<script>
  ...
  export default {
    name: 'report.charge.rpt_charge_014',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = '长益高速通行费收费情况主要统计指标';
        //用户levelya
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/charge/rpt_charge_014_01_长益高速通行费收费情况主要统计指标.cpt&__bypagesize__=false',
          this.queryParams);
