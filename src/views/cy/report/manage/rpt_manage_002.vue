      ...
      async getData() {
        ...
        if (this.queryParams.dateStatisticType === 'day') {
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startDay,
            ...
            this.queryParams.fileName = sysOrg.name + '-折算全程车流日报-' + moment(new Date()).format('YYYY-MM-DD');
          ...
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startMonth,
            ...
            this.queryParams.dateStatisticType);
            this.queryParams.fileName = sysOrg.name + '-折算全程车流月报-' + moment(new Date()).format('YYYY-MM-DD');
        }
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/manage/rpt_manage_002_01_折算全程车流日报.cpt',
          this.queryParams);
