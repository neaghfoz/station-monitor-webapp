...
<script>
  ...
  export default {
    name: 'report.manage.rpt_manage_010',
    ...
    methods: {
      async getData() {
        ...
        var beforedateTrans;
          ...
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startMonth,
            ...
            this.queryParams.dateStatisticType);
             ...
             this.queryParams.endYear = this.startYear;
        ...
        this.queryParams.fileName = sysOrg.name + '-日均车流收入汇总表-' + moment(new Date()).format('YYYY-MM-DD');
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/manage/rpt_manage_010_01_日均车流收入汇总表.cpt&op=write',
          this.queryParams);

        //更新查询统计次数
        //updateRptSearchTimes('rpt_manage_005');
