        ...
        <el-form-item label="统计日期" prop="dates">
          <el-col :span="30">
            <el-form-item v-show="queryParams.dateStatisticType==='day'">
              ...
              <ti-date-range ref="dayRang" :editable="false" dateRule="singleYear" v-model="queryParams"
                             date-type="daterange"
            ...
            <el-form-item v-show="queryParams.dateStatisticType==='month'">
              ...
              <ti-date-range ref="monthRang" :editable="false"  dateRule="singleYear" v-model="queryParams"
...
<script>
  ...
  export default {
    name: 'report.manage.rpt_manage_017',
    ...
    methods: {
      async getData() {
        ...
        if (this.queryParams.dateStatisticType === 'day') {
          ...
          this.queryParams.fileName = sysOrg.name + '-RKE高速项目日均饱和流量状况表日报-' + moment(new Date()).format('YYYY-MM-DD');
          ...
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startMonth,
            ...
            this.queryParams.dateStatisticType);
          this.queryParams.fileName = sysOrg.name + '-RKE高速项目日均饱和流量状况表月报-' + moment(new Date()).format('YYYY-MM-DD');
        }
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/manage/rpt_manage_017_01_日均饱和流量状况表.cpt',
          this.queryParams);
