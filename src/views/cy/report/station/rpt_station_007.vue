...
<script>
  ...
  export default {
    name: 'report.station.rpt_station_007',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '长益高速收费站通行费收入变化月报表';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/station/rpt_station_007_01_长益高速收费站通行费收入变化月报表.cpt',this.queryParams);
      }
    }
  }
</script>
