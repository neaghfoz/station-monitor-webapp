...
<script>
  ...
  export default {
    name: 'report.station.rpt_station_08',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '通行费收入与上年同期情况';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/station/rpt_station_008_01_通行费收入与上年同期情况.cpt',this.queryParams);
      }
    }
  }
</script>
