...
<script>
  ...
  export default {
    name: 'report.station.rpt_station_011',
    ...
    methods: {
      async getData() {
        ...
        //参数
        this.queryParams.fileName = '车流量及客货车收入情况汇总月报表';
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/station/rpt_station_011_01_车流量及客货车收入情况汇总月报表.cpt',this.queryParams);
      }
    }
  }
</script>
