...
<script>
  ...
  export default {
    name: 'report.station.rpt_manage_014',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams.fileName = '车辆通行异常情况及系统外收入情况月报表';
        //用户levelya
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/station/rpt_station_014_01_车辆通行异常情况及系统外收入情况月报表.cpt&__bypagesize__=false',
          this.queryParams);
