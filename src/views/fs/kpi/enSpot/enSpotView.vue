  ...
  <div class="app-container auditForm" style="min-height: calc(100vh - 84px);display: flex;flex-direction: column;">
    <el-form ref="appForm" :show-message="false" :model="appForm" inline :rules="rules" :label-width="'100px'">
      ...
      <el-form-item label="入口车道号" prop="laneNo">
        <ti-sys-lane clearable clearable style="width: 150px;" :show-all="true" v-model="appForm.laneNo"  :cache="true" :station-id="appForm.stationId"/>
      </el-form-item>
      ...
      <el-form-item label="入口流水号" prop="listNo">
        <el-input style="width: 150px" v-model="appForm.listNo" type="text"
                  placeholder="入口流水号" maxlength="64"/>
      </el-form-item>
    ...
    <div style="flex:1;min-height: 400px;">
      <vxe-grid
        ...
        <template v-slot:tbars>
          <el-button v-permission="['relatedEnlist:expSpot']" type="primary" @click="expWork">导出</el-button>
        </template>
      </vxe-grid>
    </div>
...
import { findList } from "@/views/fs/kpi/enSpot/enSpotApi"
  ...
  data() {
    return {
      ...
      appForm: {
        ...
        beginDate:this.$moment().add(-360, 'day').format('YYYY-MM-DD')+" 00:00:00",
      ...
      table:{
        ...
        columns: [
          ...
          { field: 'workOrderId', title: '关联工单', minWidth: 130, align: 'center' },
          { field: 'listNo', title: '入口处理编号', minWidth: 130, align: 'center' },
          { field: 'listTypeTxt', title: '流水类型', minWidth: 120, align: 'center' },
          { field: 'specialType', title: '特情类型', minWidth: 150, align: 'center' },
          { field: 'enVehiclePlateTxt', title: '入口车牌', minWidth: 100, align: 'center' },
          { field: 'enIdentifyVehiclePlateTxt', title: '识别车牌', minWidth: 100, align: 'center' },
          ...
          { field: 'enTime', title: '入口时间', minWidth: 130, align: 'center' },
          { field: 'enStationName', title: '入口收费站', minWidth: 120, align: 'center' },
          ...
          { field: 'auditResultTxt', title: '稽核结论', minWidth: 120, align: 'center' },
          { field: 'auditUserId', title: '稽核人员', minWidth: 100, align: 'center'},
          { field: 'auditTime', title: '稽核时间', minWidth: 130, align: 'center' },
      ...
      exportExcel: {
        url: 'api/v1/kpi/relatedEnlist/expSpot',
        dialog: false,
        queryParams: {},
        type: 'curpage'
      }
