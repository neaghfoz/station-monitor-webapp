  ...
  <div class="app-container auditForm" style="min-height: calc(100vh - 84px);display: flex;flex-direction: column;">
    <el-form ref="appForm" :show-message="false" :model="appForm" inline :rules="rules" :label-width="'100px'">
      ...
      <el-form-item label="流水类型" prop="listType">
        <!--<ti-select style="width: 150px;" filterable v-model="appForm.listType"  dict-type="tibms_kpi_listType" :multiple="false"/>-->
      ...
      <el-form-item label="出口操作员" prop="exOperatorId">
        <ti-sys-user clearable filterable with-have-org-user style="width: 150px;" v-model="appForm.exOperatorId" :org-id="appForm.sysOrgIdStr"/>
      </el-form-item>
    ...
    <div style="flex:1;min-height: 400px;">
      <vxe-grid
        ...
        <template v-slot:tbars>
          <el-button v-permission="['relatedExlist:exp']" type="primary" @click="expWork">导出</el-button>
        </template>
      </vxe-grid>
    </div>
...
import { findList } from "@/views/fs/kpi/exAudit/exAuditApi"
...
export default {
  ...
  data() {
    return {
      ...
      exportExcel: {
        url: 'api/v1/kpi/relatedExlist/exp',
        dialog: false,
        queryParams: {},
        type: 'curpage'
      }
