...
<script>
  ...
  export default {
    name: 'report.kpi.fs_rpt_kpi_001_01',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams._filename_ = "月份考核报表";
        console.log("getDefaultFirstValue:", this.$refs.serviceOrgId.getDefaultFirstValue().id);
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/kpi/fs_rpt_kpi_001_01_月份考核报表.cpt',
          this.queryParams);

        //更新查询统计次数
        //updateRptSearchTimes('fs_rpt_kpi_001_01_月份考核报表');
