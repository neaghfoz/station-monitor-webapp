...
<script>
  ...
  export default {
    name: 'report.kpi.fs_rpt_kpi_003_01',
    ...
    methods: {
      async getData() {
        ...
        this.queryParams._filename_ = "年度考核报表";
        console.log("queryParams:", this.queryParams);
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/kpi/fs_rpt_kpi_003_01_年度考核报表.cpt',
          this.queryParams);

        //更新查询统计次数
        //updateRptSearchTimes('fs_rpt_kpi_003_01_年度考核报表');
