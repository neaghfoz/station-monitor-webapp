...
<script>
  ...
  export default {
    name: 'report.kpi.fs_rpt_specialEvent_002_01',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/specialEvent/fs_rpt_specialEvent_002_01_出口站特殊车辆汇总报表.cpt',
          this.queryParams);

        //更新查询统计次数
        //updateRptSearchTimes('fs_rpt_specialEvent_002_01_出口站特殊车辆汇总报表');
