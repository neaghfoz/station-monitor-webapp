...
import { reverseOut, checkPaper } from '../paperApi'
  ...
  data() {
    return {
      ...
      table: {
        ...
        columns: [
          { field: 'paperStartShowNo', title: '已调出纸券起始号', minWidth: 135, align: 'center',
            editRender: { }, slots: { edit: 'paperStartNoShowEdit' }},
          { field: 'paperEndShowNo', title: '已调出纸券终止号', minWidth: 135, align: 'center',
            editRender: { }, slots: { edit: 'paperEndNoShowEdit' }},
          { field: 'paperStartNo', title: '撤销调出纸券起始号', minWidth: 150, align: 'center',
            editRender: { }, slots: { edit: 'paperStartNoEdit' }},
          { field: 'paperEndNo', title: '撤销调出纸券终止号', minWidth: 150, align: 'center',
      ...
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          try {
            ...
            await reverseOut(this.formItem)
            this.$notify.success('撤销调出成功')
