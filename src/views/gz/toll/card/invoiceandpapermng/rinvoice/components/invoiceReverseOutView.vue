...
import { reverseOut, checkExistsInv } from '../rinvoiceApi'
    ...
    return {
      ...
      table: {
        ...
        columns: [
          ...
          { field: 'invStartShowNo', title: '已调出发票起始号', minWidth: 135, align: 'center',
            editRender: { }, slots: { edit: 'invStartNoShowEdit' }},
          { field: 'invEndShowNo', title: '已调出发票终止号', minWidth: 135, align: 'center',
            editRender: { }, slots: { edit: 'invEndNoShowEdit' }},
          { field: 'invStartNo', title: '撤销调出发票起始号', minWidth: 150, align: 'center',
            editRender: { }, slots: { edit: 'invStartNoEdit' }},
          { field: 'invEndNo', title: '撤销调出发票终止号', minWidth: 150, align: 'center',
