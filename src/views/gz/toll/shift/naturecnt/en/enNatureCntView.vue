    ...
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <el-row>
          ...
          <el-form-item>
            <el-button v-permission="['stationEnCount:findPage']" type="primary" @click="getData">查询</el-button>
    ...
    return {
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '纸劵发卡数', field: 'paperCountText', minWidth: 120, showOverflow: true, align: 'right' },
