    ...
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <el-row>
          ...
          <el-form-item>
            <el-button v-permission="['stationExCount:findPage']" type="primary" @click="getData">查询</el-button>
      ...
      <div class="box">
        ...
        >
          <template v-slot:operation="{ row }">
            <el-button type="warning" @click="detailRow(row)" v-permission="['stationExCount:detail']">详情</el-button>
          </template>

          <template v-slot:toolbar_buttons>
            <el-button type="info" @click="exportExcel.dialog = true" v-permission="['stationExCount:excel']">导出</el-button>
          </template>
...
import { findPage } from './exNatureCntApi'
import tiSysOrg from '@/views/pro/common/tiElement/tiSysOrg/tiSysOrg'
import TiDateRange from '@/views/pro/common/tiElement/tiDate/tiDateRange'
import TiExportExcel from '@/views/pro/common/tiElement/tiExport/tiExportExcel'
import detailView from './components/exNatureCntDetailView'
    ...
    return {
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '总金额', field: 'currentFeeSumText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: 'ETC成功交易额', field: 'etcSuccessFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: 'ETC失败交易额', field: 'etcFailFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: 'CPC成功交易额', field: 'cpcSuccessFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: 'CPC成功交易额', field: 'cpcFailFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: '纸劵成功交易额', field: 'paperSuccessFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: '纸劵失败交易额', field: 'paperFailFeeText', minWidth: 120, showOverflow: true, align: 'right' },
      ...
      selections: [],
      exportExcel: {
        url: '/api/v1/stationexcount/exportExcel',
        dialog: false,
        queryParams: {},
        type: 'curpage'
      }
