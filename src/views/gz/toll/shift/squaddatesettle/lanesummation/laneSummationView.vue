      ...
      <div class="box">
        ...
        >
          ...
          <template v-slot:toolbar_buttons>
           <!-- <el-button type="primary" :disabled="tableData.selections.length === 0" @click="gen()" v-permission="['lanesummation:create']">结算</el-button>-->
...
export default {
  name: 'gz.toll.shift.squadDateSettle.laneSummationView',
  ...
  data() {
    return {
      ...
      queryParams: {
        sysOrgIdStr: '',
        squadNo: '',
        beginSquadDate: moment(new Date()).subtract(1, "days").format('YYYY-MM-DD'),
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '通行流水数', field: 'recordCntText', minWidth: 120, showOverflow: true, align: 'right' },
