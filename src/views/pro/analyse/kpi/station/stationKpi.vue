...
<script>
  ...
  import tableOption from "@/views/pro/analyse/kpi/station/tableOption"
  import {getData} from "./stationKpiApi"
  import moment from "moment"
  import chartOption from "@/views/pro/analyse/kpi/station/chartOption"
  import tiSysOrg from "@/views/pro/common/tiElement/tiSysOrg/tiSysOrg";
  import dictUtils from 'ecip-web/utils/dictUtils';

  export default {
    name: "analyse.kpi.station.stationKpiView.vue",
    mixins: [...mixin],
