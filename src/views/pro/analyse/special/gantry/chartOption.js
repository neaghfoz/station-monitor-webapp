...
export default  {
  ...
  show:function(dataArr, params){
    ...
    for(let i in dataArr){
      ...
      if (params.valueType ==='1' || params.activeName === 'transDate') {
        data.specialCnt.push(vo.specialCnt)

        this.barOption.legend.data[0] = '特情流水数'
        this.barOption.yAxis.name='单位（条）'
        this.barOption.series[0].name='特情流水数'
        ...
        this.barOption.legend.data[0] = '特情占比'
        this.barOption.yAxis.name='单位（%）'
        this.barOption.series[0].name='特情占比'
    ...
    let curOption = {}
    if (params.activeName ==='transDate') {
    ...
    curOption.title.text = '门架特情分析' + typeName + '图表';
    this.myChart.clear()
