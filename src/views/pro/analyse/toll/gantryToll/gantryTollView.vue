...
<script>
  ...
  import tableOption from "@/views/pro/analyse/toll/gantryToll/tableOption";
  import chartOption from "@/views/pro/analyse/toll/gantryToll/chartOption";
  import tiSysOrg from "@/views/pro/common/tiElement/tiSysOrg/tiSysOrg";
  import {getOrgTreeData} from "@/views/pro/common/util/dataUtil";

  export default {
    name: "analyse.toll.gantryToll.gantryTollView",
    mixins: [...mixin],
    ...
    methods:{
      async getData() {
        ...
        if (this.queryParams.showDefault === 'chart') {
          chartOption.show(tableOption.returnData.data.chart, type);
        }
      },
      ...
      export() {
        tableOption.export(this.$refs.appTable, '门架通行费分析')
      },
      handleReset() {
