        ...
        <div class="flex todo">
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              ...
              <div><i style="background: #21d4b6;"></i>收益快报(万元)<span class="text-green">{{ top.st1.splitFee }}</span>
              </div>
              <el-tooltip class="item" effect="dark" content="公式:(收益快报-理论应收)/理论应收*100%" placement="bottom">
                <div>
          ...
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              ...
              <div><i style="background: #21d4b6;"></i>收益快报<span class="text-green">{{ top.st2.splitFee }}</span></div>
          ...
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              ...
              <div><i style="background: #21d4b6;"></i>收益快报<span class="text-green">{{ top.st3.splitFee }}</span></div>
...
<script>
  ...
  import chartOption from "@/views/pro/audit/fee/indexFee/chartOption"
  ...
  export default {
    name: 'audit.fee.indexFee.indexFee',
    mixins: [...mixin],
