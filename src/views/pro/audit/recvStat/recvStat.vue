    ...
    <el-form ref="searchForm" :rules="searchRules" :model="queryParams" inline :label-width="'100px'">
      <el-row>
        ...
        <el-form-item label="数据类型" prop="dataTypes">
           <ti-select ref="dataTypes" v-model="queryParams.dataTypes" dict-type="tibms_audit_dataType"
                      :multiple="true"/>
        </el-form-item>
        <el-form-item label="数据交易时间" label-width="110px" prop="transDateRange">
        ...
        <el-form-item class="searchItem" :label-width="'50px'">
          ...
          <el-button type="success"  v-permission="['dataIntegrity:exportExcel']" @click="exportExcel.dialog = true">导出</el-button>
        </el-form-item>
      </el-row>
    </el-form>
...
<script>
  ...
  import {findPage} from "@/views/pro/audit/recvStat/recvStat";
