<template>
  <div class="app-container">
    <el-form v-if="showSearchForm" ref="searchForm" :model="queryParams" inline :label-width="'155px'">
      <el-row>
...
<!--          <el-form-item label="车道号" prop="laneNo">
          ...
          <el-form-item label="车道号" prop="laneNoStr">
            <ti-sys-lane clearable style="width: 150px;"  v-model="queryParams.laneNoStr"  :cache="true" :station-id="appForm.stationId" :multiple="true" />
          </el-form-item>
          ...
          <el-form-item label="在用版本号" prop="usingVer"  >
            <el-input
          ...
          <el-form-item label="最新版本号" prop="latestVer" >
            <el-input
          ...
          <el-form-item label="最新版本状态变化时间" >
            ...
            <ti-date-range
              ...
              dateStyle="width:525px"
            />
          </el-form-item>

          <el-form-item label="最新版本更新状态" prop="statusStr">
      ...
      <div class="box">
        ...
        >
          <template v-slot:operation="{ row }">
            <el-button v-permission="['updateStatus:details']" type="warning" @click="detail(row)" >详情</el-button>
          </template>

          <template v-slot:toolbar_buttons>
            <el-button   type="warning" @click="exportExcel.dialog = true" v-permission="['updateStatus:export']">导出</el-button>
          </template>
...
import { updateStatusList, allSystems } from './updateStatus'
...
export default {
  name: 'AutoUpdationUpdateStatusListView',
  ...
  data() {
    return {
      ...
      tableData: {
        ...
        columnsDataList: [],
        tableColumns: [
          { title: '所属系统', field: 'systemName', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '路段', field: 'roadName', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '收费站', field: 'stationName', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '车道', field: 'laneNo', minWidth: 80, showOverflow: true, align: 'center' },
          { title: '车道类型', field: 'terminalTypeText', minWidth: 140, showOverflow: true, align: 'center' },
          { title: '出入口类型', field: 'enexTypeText', minWidth: 100, showOverflow: true, align: 'center' },
          { title: '目标网址', field: 'ipAddress', minWidth: 130, showOverflow: true, align: 'center' },
          { title: '在用版本号', field: 'usingMainVer', minWidth: 150, showOverflow: true, align: 'center' },
          { title: '在用更新时间', field: 'usingVerTime', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '最新版本号', field: 'latestMainVer', minWidth: 150, showOverflow: true, align: 'center'},
          { title: '最新版本状态变化时间', field: 'latestVerTime', minWidth: 180, showOverflow: true, align: 'center' },
          { title: '最新版本更新状态', field: 'statusText', minWidth: 100, showOverflow: true, align: 'center' },
      ...
      tableHeight: null,
      exportExcel: {
        url: '/api/v1/version/updateStatus/exportExcel',
        dialog: false,
        queryParams: {},
        type: 'curpage'
      },
  ...
  methods: {
    ...
    detail(row) {
      this.$router.push({
        path: '/autoUpdation/version/updateStatus/details',
        query: { id: row.id }
      })
    },
    add() {
