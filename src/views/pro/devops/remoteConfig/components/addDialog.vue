        ...
        <el-row :gutter="15">
          <el-col :span="24">
            <el-form-item label="服务器端口" prop="serverPort"
                          :rules="[ { required: true, message:'服务器端口不能为空', trigger:'change' } ]">
              <el-input v-model="formItem.serverPort" maxlength="50" type="text" placeholder="服务器端口"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="15">
          <el-col :span="24">
            <el-form-item label="ftp端口" prop="ftpPort"
                          :rules="[ { required: true, message:'ftp端口不能为空', trigger:'change' } ]">
              <el-input v-model="formItem.ftpPort" maxlength="50" type="text" placeholder="ftp端口"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="15">
          <el-col :span="24">
            <el-form-item label="ftp日志路径" prop="ftpLogPath">
              <el-input v-model="formItem.ftpLogPath" maxlength="50" type="text" placeholder="ftp日志路径"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
  ...
  import {add, addMobile} from '../remoteConfigApi'
  import {getCurrentOrgPath} from "@/views/pro/common/util/dataUtil"

  export default {
    name: 'devops.remoteConfig.components.addDialog',
    components: {tiSysOrg},
    mixins: [...mixin],
    data() {
      return {
