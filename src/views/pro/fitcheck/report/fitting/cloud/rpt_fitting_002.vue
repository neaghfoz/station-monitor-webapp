...
<script>
  ...
  export default {
    name: 'fitcheck.report.fitting.cloud.rpt_fitting_002',
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            if(statLat == "vehicleType"){
                rptUrl = rptUrl + "rpt_fitting_002_01_拟合按收费单元分车型车流量报表.cpt";
                rptLogType = "rpt_fitting_002_01";
            }else if(statLat == "vehicleClass"){
                rptUrl = rptUrl + "rpt_fitting_002_02_拟合按收费单元分车种车流量报表.cpt";
                rptLogType = "rpt_fitting_002_02";
            }
