...
<script>
  ...
  export default {
    name: 'fitcheck.report.fitting.local.rpt_fitting_road_01',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/fitting'+this.rptPrex+'/rpt_fitting_road_01_拟合应收车流量按路段维度报表.cpt',this.queryParams);

            //更新查询统计次数
            //updateRptSearchTimes('rpt_fitting_road_01');
