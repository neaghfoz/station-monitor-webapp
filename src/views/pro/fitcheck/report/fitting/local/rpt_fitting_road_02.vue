...
<script>
  ...
  export default {
    name: 'fitcheck.report.fitting.local.rpt_fitting_road_02',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/fitting'+this.rptPrex+'/rpt_fitting_road_02_拟合应收通行费按路段维度报表.cpt',this.queryParams);

            //更新查询统计次数
            //updateRptSearchTimes('rpt_fitting_road_02');
