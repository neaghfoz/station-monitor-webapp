        ...
        <el-row>
          ...
          <el-form-item label="收费单元">
            <ti-select
              ...
              :watch-attr="queryParams.sectionId"
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          tollIntervalIdStr:'',
          startDay:dateUtil.getNextDate(new Date(),'days',-7,'YYYY-MM-DD'),
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            var rptUrl = "/ReportServer?reportlet=report/fitcheck/fitting/fitting"+this.rptPrex+"/";
            var rptLogType = "";
