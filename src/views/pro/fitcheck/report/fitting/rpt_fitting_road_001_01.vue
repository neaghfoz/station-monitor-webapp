...
<script>
  ...
  export default {
    name: 'fitcheck.report.fitting.cloud.rpt_fitting_road_001_01',
    ...
    methods:{
      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/fitting'+this.rptPrex+'/rpt_fitting_road_001_01_拟合应收通行费按路段维度分车型报表.cpt',this.queryParams);

            //更新查询统计次数
            //updateRptSearchTimes('rpt_fitting_road_001_01');
          } else {
      ...
      async getRoadIdStr(sysOrg){
        //用户level
        console.log("sysOrg:",sysOrg);
