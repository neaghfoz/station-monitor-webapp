      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck'+this.rptPrex+'/cloud/rpt_fitting_road_002_01_拟合应收车流量按路段维度分车型报表.cpt',this.queryParams);
