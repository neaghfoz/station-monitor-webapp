...
<script>
  ...
  export default {
    name: 'fitcheck.report.theory.rpt_theory_road_001_01',
      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/theory/local/rpt_theory_road_001_01_理论应收通行费按路段维度分车型报表.cpt',this.queryParams);
