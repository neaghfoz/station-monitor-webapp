...
<script>
  ...
  export default {
    name: 'fitcheck.report.theory.rpt_theory_road_01',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/theory/local/rpt_theory_road_01_理论应收车流量按路段维度报表.cpt',this.queryParams);
