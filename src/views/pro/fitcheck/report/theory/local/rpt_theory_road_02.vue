...
<script>
  ...
  export default {
    name: 'fitcheck.report.theory.rpt_theory_road_02',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitcheck/theory/local/rpt_theory_road_02_理论应收通行费按路段维度报表.cpt',this.queryParams);
