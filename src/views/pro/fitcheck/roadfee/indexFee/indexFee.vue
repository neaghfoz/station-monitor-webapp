        ...
        <div class="flex todo">
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              <div><i style="background: #0088ff;"></i>理论应收(万元)<span class="text-blue">{{ top.st1.fee }}</span></div>
              <div><i style="background: #feb42f;"></i>拟合应收(万元)<span class="text-yellow">{{ top.st1.payFee }}</span>
              </div>
              <div><i style="background: #21d4b6;"></i>拆分实收(万元)<span class="text-green">{{ top.st1.splitFee }}</span>
              </div>
              <el-tooltip class="item" effect="dark" content="公式:(拆分实收-拟合应收)/拟合应收*100%" placement="bottom">
                <div>
          ...
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              <div><i style="background: #0088ff;"></i>理论应收<span class="text-blue">{{ top.st2.fee }}</span></div>
              <div><i style="background: #feb42f;"></i>拟合应收<span class="text-yellow">{{ top.st2.payFee }}</span></div>
              <div><i style="background: #21d4b6;"></i>拆分实收<span class="text-green">{{ top.st2.splitFee }}</span></div>
          ...
          <div class="flexItem flex">
            ...
            <div class="flexItem dotted">
              <div><i style="background: #0088ff;"></i>理论应收<span class="text-blue">{{ top.st3.fee }}</span></div>
              <div><i style="background: #feb42f;"></i>拟合应收<span class="text-yellow">{{ top.st3.payFee }}</span></div>
              <div><i style="background: #21d4b6;"></i>拆分实收<span class="text-green">{{ top.st3.splitFee }}</span></div>
          ...
          <div class="flexItem">
            <el-card class="box-card" shadow="never" v-loading="txfjhqst.loading">
              ...
              <div class="text item">
                ...
                <div ref="txfjhqst2" data-chart="bar" class="chart" style="height:300px;"
                     v-show="$data.txfjhqst.chartType==2"></div>
              </div>
            </el-card>
          </div>
        </div>
...
<script>
  ...
  import chartOption from "@/views/pro/fitcheck/roadfee/indexFee/chartOption"
  ...
  export default {
    name: 'fitcheck.roadfee.indexFee.indexFee',
    mixins: [...mixin],
