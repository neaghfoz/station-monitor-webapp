...
<script>
  ...
  export default {
    name: 'report.fitting.rpt_fitting_002',
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            if(statLat == "vehicleType"){
              ...
              this.queryParams.__filename__ = this.queryParams.roadName+"-"+"拟合按收费单元分车型车流量报表-" +moment(new Date()).format('YYYYMMDD');
            }else if(statLat == "vehicleClass"){
                rptUrl = rptUrl + "rpt_fitting_002_02_拟合按收费单元分车种车流量报表.cpt";
                rptLogType = "rpt_fitting_002_02";
                this.queryParams.__filename__ = this.queryParams.roadName+"-"+"拟合按收费单元分车种车流量报表-" +moment(new Date()).format('YYYYMMDD');
            }
