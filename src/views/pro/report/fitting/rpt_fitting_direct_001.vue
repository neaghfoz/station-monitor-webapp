...
<script>
  ...
  export default {
    name: 'report.fitting.rpt_fitting_direct_001',
    ...
    methods:{
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          rptUrl = rptUrl + "rpt_fitting_direct_001_拟合应收定向通行费报表.cpt";
          rptLogType = "rpt_fitting_direct_001";
          this.queryParams.__filename__ = this.queryParams.roadName+"-"+"拟合应收定向通行费报表-" +moment(new Date()).format('YYYYMMDD');
