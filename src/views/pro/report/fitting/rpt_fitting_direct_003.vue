...
<script>
  ...
  export default {
    name: 'report.fitting.rpt_fitting_direct_003',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            rptUrl = rptUrl + "rpt_fitting_direct_003_拟合应收折算车流量报表.cpt";
            rptLogType = "rpt_fitting_direct_003";
            this.queryParams.__filename__ = this.queryParams.roadName+"-"+"拟合应收折算车流量报表-" +moment(new Date()).format('YYYYMMDD');
