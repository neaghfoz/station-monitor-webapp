...
<script>
  ...
  export default {
    name: 'report.fitting.rpt_fitting_road_002_01',
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          orgNo:'',
          sectionId:'',
          __filename__:'拟合应收车流量按路段维度分车型报表'
      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.queryParams.__filename__ = this.queryParams.roadName+"-"+"拟合应收车流量按路段维度分车型报表-" +moment(new Date()).format('YYYYMMDD');
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/fitting/rpt_fitting_road_002_01_拟合应收车流量按路段维度分车型报表.cpt',this.queryParams);
