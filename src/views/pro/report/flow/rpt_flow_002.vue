    ...
    <el-form ref="searchForm"  :model="queryParams" inline :label-width="'100px'" v-bind:style="{height: searchFormHeight}">
      ...
      <el-form-item ref ="elRowAll" style="margin-bottom:0">
        ...
        <el-form-item label="出入口类型" prop="inOutType">
          <ti-select style="width:180px" :clearable="false" v-model="queryParams.inOutType" dict-type="tibms_com_inOutType"/>
        </el-form-item>
    ...
    methods: {
     async getData() {
      ...
      this.reportUrl = fineReportUtil.getUrl(
        '/ReportServer?reportlet=report/flow/rpt_flow_002_01_分站分车种车流量报表.cpt',
        this.queryParams);

      //更新查询统计次数
      updateRptSearchTimes('rpt_flow_002');
