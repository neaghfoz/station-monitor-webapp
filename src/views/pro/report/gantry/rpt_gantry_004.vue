...
<script>
  ...
  export default {
    name: 'report.gantry.rpt_gantry_004',
      ...
      getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/gantry/rpt_gantry_004_01_分门架分车种通行费报表.cpt',this.queryParams);

            //更新查询统计次数
            updateRptSearchTimes('rpt_gantry_004');
          }
          else
          {
