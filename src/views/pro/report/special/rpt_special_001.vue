        ...
        <el-form-item ref ="elRowAll" style="margin-bottom:0">
          <el-row>
            ...
            <el-form-item label="车道号" prop="laneNo">
              <el-input style="width:180px" v-model="queryParams.laneNo" type="text" placeholder="车道号" maxlength="5"
                        oninput="value=value.replace(/[^\d]/g, '')"/>
            </el-form-item>
            <!--      <el-form-item label="类型" label-width="80px" prop="overloadType">-->
            <!--        <ec-select   v-model="queryParams.overloadType" dict-type="tibms_rpt_overloadType"/>-->
            <!--      </el-form-item>-->
...
<script>
  ...
  export default {
    name: 'report.special.rpt_special_001',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/special/rpt_special_001_01_入口治超货车报表.cpt',
          this.queryParams);

        //更新查询统计次数
        updateRptSearchTimes('rpt_special_001');
