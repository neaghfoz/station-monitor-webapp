...
<script>
  ...
  export default {
    name: 'report.special.rpt_special_002',
    ...
    methods:{
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/special/rpt_special_002_01_闯关车报表.cpt',this.queryParams);

        //更新查询统计次数
        updateRptSearchTimes('rpt_special_002');
