...
<script>
  ...
  export default {
    name: 'report.special.rpt_special_004',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/special/rpt_special_004_01_节假日免费分车种车流量报表.cpt',
          this.queryParams);

        //更新查询统计次数
        updateRptSearchTimes('rpt_special_004');
