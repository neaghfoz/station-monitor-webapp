...
<script>
  ...
  export default {
    name: 'report.theory.rpt_theory_002',
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            if(statLat == "vehicleType"){
                rptUrl = rptUrl + "rpt_theory_002_01_理论按收费单元分车型车流量报表.cpt";
                rptLogType = "rpt_theory_002_01";
                this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论按收费单元分车型车流量报表-" +moment(new Date()).format('YYYYMMDD');
            }else if(statLat == "vehicleClass"){
                rptUrl = rptUrl + "rpt_theory_002_02_理论按收费单元分车种车流量报表.cpt";
                rptLogType = "rpt_theory_002_02";
                this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论按收费单元分车种车流量报表-" +moment(new Date()).format('YYYYMMDD');
            }
