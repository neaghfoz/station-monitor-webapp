...
<script>
  ...
  export default {
    name: 'report.theory.rpt_theory_direct_001',
    ...
    methods:{
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论应收定向通行费报表-" +moment(new Date()).format('YYYYMMDD');
