...
<script>
  ...
  export default {
    name: 'report.theory.rpt_theory_direct_002',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论应收定向车流量报表-" +moment(new Date()).format('YYYYMMDD');
