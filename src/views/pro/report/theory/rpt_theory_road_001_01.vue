...
<script>
  ...
  export default {
    name: 'report.theory.rpt_theory_road_001_01',
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          orgNo:'',
          sectionId:'',
          __filename__:'理论应收通行费按路段维度分车型报表'
      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论应收通行费按路段维度分车型报表-" +moment(new Date()).format('YYYYMMDD');
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/theory/rpt_theory_road_001_01_理论应收通行费按路段维度分车型报表.cpt',this.queryParams);

            //更新查询统计次数
            updateRptSearchTimes('rpt_theory_road_001_01');
          } else {
