...
<script>
  ...
  export default {
    name: 'report.theory.rpt_theory_road_01',
      ...
      async getData() {
        ...
        if(!this.queryParams.sectionId){
          ...
          this.queryParams.roadName = value.roadName;
            ...
            this.queryParams.__filename__ = this.queryParams.roadName+"-"+"理论应收车流量按路段维度报表-" +moment(new Date()).format('YYYYMMDD');
            //console.log("queryParams:",this.queryParams);
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/theory/rpt_theory_road_01_理论应收车流量按路段维度报表.cpt',this.queryParams);

            //更新查询统计次数
            updateRptSearchTimes('rpt_theory_road_01');
