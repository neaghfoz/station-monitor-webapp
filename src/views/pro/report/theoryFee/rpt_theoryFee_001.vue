<template>
  <div class="app-container"  style="height: 100%">
    <el-form ref="searchForm"  :model="queryParams" inline :label-width="'100px'">
      ...
      <iframe  v-bind:src="reportUrl"  frameborder=0 border="0"  style="overflow:auto;width: 100%;height:100%;min-height: 400px"></iframe>
    </el-form>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'report.theoryFee.rpt_theoryFee_001',
      ...
      async getData() {
        ...
        this.$refs.searchForm.validate((valid) => {
          if (valid) {
            ...
            this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/theoryFee/rpt_theoryFee_001_01_分收费单元分车型通行费报表.cpt',this.queryParams);

            //更新查询统计次数
            updateRptSearchTimes('rpt_theory_001');
          } else {
