  ...
  export default {
    ...
    methods:{
      async getData() {
        ...
        {
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startDay,this.queryParams.endDay,this.queryParams.collectType,this.queryParams.dateStatisticType);
          filename = "计费方式分车型统计日报表";
        }else if(this.queryParams.dateStatisticType==='month')
        {
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startMonth,this.queryParams.endMonth,this.queryParams.collectType,this.queryParams.dateStatisticType);
          filename = "计费方式分车型统计月报表";
        ...
        this.reportUrl = fineReportUtil.getUrl('/ReportServer?reportlet=report/toll/rpt_toll_003_01_计费方式分车型统计报表.cpt',this.queryParams);

        //更新查询统计次数
        updateRptSearchTimes('rpt_toll_003');
