    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/toll/rpt_toll_004_01_分站通行费汇总统计报表.cpt',
          this.queryParams);

        //更新查询统计次数
        updateRptSearchTimes('rpt_toll_004');
