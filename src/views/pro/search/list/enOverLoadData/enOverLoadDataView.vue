...
<!--                           end-key="endDate"/>            -->
    ...
    >
      <template v-slot:toolbar_buttons>
        <el-button v-permission="['enOverLoadData:exportExcel']" @click="exportExcel.dialog = true">导出</el-button>
      </template>

      <template v-slot:operation="{ row }">
        <el-button v-permission="['enOverLoadData:detail']" type="warning" @click="detail(row.hgSeq, row.enTolllaneId, row.checkTimeText)">详情</el-button>
      </template>
    </vxe-grid>
...
<script>
  ...
  import {findPage, exportExcel} from "./enOverLoadDataApi";
  ...
  export default {
    name: 'search.list.enOverLoadData.enOverLoadDataView',
    ...
    data() {
      return {
        ...
        importUrl: 'api/v1/search/list/enOverLoadData/importExcel',
        tplUrl: 'api/v1/search/list/enOverLoadData/excelTemplate',
        exportUrl: 'api/v1/search/listenOverLoadData/exportExcel?token=${getToken()}',
        tableToolbar: {
          id: 'search.list.enOverLoadData.enOverLoadDataView-toolbar',
          custom: true,
          slots: {
    ...
    methods: {
      ...
      detail(hgSeq, enTolllaneId, checkTimeText) {
        ...
        this.$router.push({
          path : '/search/list/enOverLoadData/detail/' + timestamp,
          query : {
            hgSeq : hgSeq,
