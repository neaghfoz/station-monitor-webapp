  ...
  <div class="app-container">
    ...
    >
      <template v-slot:toolbar_buttons>
        <el-button v-permission="['enWeightData:exportExcel']" @click="exportExcel.dialog = true">导出</el-button>
      </template>

      <template v-slot:operation="{ row }">
        <el-button v-permission="['enWeightData:detail']" type="warning" @click="detail(row.hgSeq, row.enTolllaneId, row.checkTimeText)">详情</el-button>
      </template>
    </vxe-grid>
...
<script>
  ...
  import {findPage, exportExcel} from "./enWeightDataApi";
  ...
  export default {
    name: 'search.list.enWeightData.enWeightDataView',
    ...
    data() {
      return {
        ...
        importUrl: 'api/v1/search/list/enWeightData/importExcel',
        tplUrl: 'api/v1/search/list/enWeightData/excelTemplate',
        exportUrl: 'api/v1/search/listenWeightData/exportExcel?token=${getToken()}',
        tableToolbar: {
          id: 'search.list.enWeightData.enWeightDataView-toolbar',
          custom: true,
          slots: {
    ...
    methods: {
      ...
      detail(hgSeq, enTolllaneId, checkTime) {
        ...
        this.$router.push({
          path : '/search/list/enWeightData/detail/' + timestamp,
          query : {
            hgSeq : hgSeq,
