  ...
  <div class="app-container">
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <div>
          ...
          <el-form-item label="支付方式" prop="payTypeStr">
            <ti-select v-model="queryParams.payTypeStr" dict-type="tibms_search_list_payType" multiple/>
          </el-form-item>
          <el-form-item label="交易支付方式" prop="transPayTypeStr">
            <ti-select v-model="queryParams.transPayTypeStr" dict-type="tibms_search_list_transPayType" multiple/>
          </el-form-item>
    ...
    >
      <template v-slot:toolbar_buttons>
        <el-row>
          <el-col>
            <el-button v-permission="['laneExList:exportExcel']" @click="exportExcel.dialog = true">导出</el-button>
            <el-button v-permission="['laneExList:exportExcel']" @click="colSettingFn">列配置</el-button>
      ...
      <template v-slot:operation="{ row }">
        <el-button v-permission="['laneExList:exportExcel']" type="warning" @click="detail(row)">详情</el-button>
      </template>
    </vxe-grid>
...
import {findPage} from "./laneExListApi";
...
export default {
  name: 'search.list.laneExList.laneExListView',
  ...
  data() {
    return {
      ...
      loading: false,
      tableToolbar: {
        id: 'search.list.laneExList.laneExListView-toolbar',
        custom: true,
        slots: {
  ...
  methods: {
    ...
    colSettingFn() {
      this.$router.push({
        path: '/search/list/laneExList/colSetting',
        query: {
