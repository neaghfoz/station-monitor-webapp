    ...
    <el-form v-loading="loading" :model="detailItem">
      ...
      <el-card class="box-card">
        ...
        <div>
          ...
          <el-row :gutter="5">
            <el-col :span="6"><ti-detail-cell label="现金交易流量" :value="detailItem.cashCnt"/></el-col>
            <el-col :span="6"><ti-detail-cell label="现金金额（元）" :value="detailItem.cashMnyTxt"/></el-col>
...
<script>
  ...
  import {detail} from "../laneShiftApi"
  import TiDetailCell from "@/views/pro/common/tiElement/tiDetail/tiDetailCell"

  export default {
    name: 'search.list.laneShift.laneShiftDetail',
