    ...
    data() {
      return {
        ...
        columns: [
          ...
          {title: '门架编码', field: 'gantryId', minWidth: 170, showOverflow: true},
          ...
          {
            title: '门架', align: 'center',
            children: [
              {
                title: '生成流水数', field: '', minWidth: 80, showOverflow: true, align: 'right', slots: {
                  default: ({row}, h) => {
                    return '-'
                  }
                }
              ...
              {
                title: '滞留流水数', field: '', minWidth: 80, showOverflow: true, align: 'right', slots: {
                  default: ({row}, h) => {
                    return '-'
                  }
                }
