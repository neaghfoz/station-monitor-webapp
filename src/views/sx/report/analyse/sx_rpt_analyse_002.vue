...
<script>
  ...
  export default {
    name: 'report.analyse.sx_rpt_analyse_002',
      ...
      async getData() {
        ...
        if (this.queryParams.dateStatisticType === 'day') {
          ...
          this.reportUrl = fineReportUtil.getUrl(
            '/ReportServer?reportlet=report/analyse/sx_rpt_analyse_002_01_出口运营分析报表.cpt&__filename__=出口运营分析报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
            this.queryParams);
