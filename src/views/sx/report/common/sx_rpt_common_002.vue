...
<script>
  ...
  export default {
    name: 'report.common.sx_rpt_common_002',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/common/sx_rpt_common_002_01 _心跳数据报表.cpt&__filename__=心跳数据报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
