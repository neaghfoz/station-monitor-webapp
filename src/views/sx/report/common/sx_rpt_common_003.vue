    ...
    <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
      ...
      <el-form-item label="统计类型" prop="collectType">
        <ti-select :clearable="false" v-model="queryParams.collectType"
                   :data-list="[{value:'0',name:'含ETC免费车'},{value:'1',name:'不含ETC免费车'}]"
...
<script>
  ...
  export default {
    name: 'report.common.sx_rpt_common_003',
      ...
      async getData() {
        ...
        if (this.queryParams.dateStatisticType === 'day') {
          dateTrans = dateUtil.collectTypeCombination(this.queryParams.startDay,
            this.queryParams.endDay, 'squadDate',
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/common/sx_rpt_common_003_01_出口车种分类时间段报表.cpt&__filename__=出口车种分类时间段报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
