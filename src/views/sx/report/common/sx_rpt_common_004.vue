...
<script>
  ...
  export default {
    name: 'report.common.sx_rpt_common_004',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/common/sx_rpt_common_004_01_入口车种分类时间段报表.cpt&__filename__=入口车种分类时间段报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
