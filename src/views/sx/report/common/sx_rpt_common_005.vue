<template>
  <div class="app-container" style="height: 100%">
    <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
      ...
      <el-form-item label="车道" prop="laneNoStr"  >
        <el-input
...
<script>
  ...
  export default {
    name: 'report.common.sx_rpt_common_005',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/common/sx_rpt_common_005_01_车道小时交通流量日统计表.cpt&__filename__=车道小时交通流量日统计表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
