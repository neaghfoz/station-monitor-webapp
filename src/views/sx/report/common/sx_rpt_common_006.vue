...
<script>
  ...
  export default {
    name: 'report.common.sx_rpt_common_006',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/common/sx_rpt_common_006_01_收费员流量费时间段汇总表.cpt&__filename__=收费员流量费时间段汇总表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
