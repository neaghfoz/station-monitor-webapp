...
export default {
  name: 'report.duty.sx_rpt_duty_001',
  ...
  methods: {
    async getData() {
      this.$refs.searchForm.validate(async valid => {
        ...
        var dateTrans;
        dateTrans = dateUtil.collectTypeCombination(this.queryParams.dayStr, this.queryParams.dayStr, this.queryParams.collectType, 'day');
        ...
        console.log(this.$refs.operator.options);
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/duty/sx_rpt_duty_001_01_出口车道结账表.cpt&__filename__=出口车道结账表' + XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
