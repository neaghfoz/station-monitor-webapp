...
export default {
  name: 'report.duty.sx_rpt_duty_003',
    ...
    async getData() {
      this.$refs.searchForm.validate(async valid => {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/duty/sx_rpt_duty_003_01_入口值班全表.cpt&__filename__=入口值班全表' + XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
