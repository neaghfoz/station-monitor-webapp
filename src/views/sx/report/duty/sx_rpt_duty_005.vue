...
export default {
  name: 'report.duty.sx_rpt_duty_005',
    ...
    async getData() {
      this.$refs.searchForm.validate(async valid => {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/duty/sx_rpt_duty_005_01_ETC出口值班全表.cpt&__filename__=ETC出口值班全表' + XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
