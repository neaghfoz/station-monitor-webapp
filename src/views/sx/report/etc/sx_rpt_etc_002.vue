...
<script>
  ...
  export default {
    name: 'report.etc.sx_rpt_etc_002',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/etc/sx_rpt_ETC_002_01_新ETC出口车型交通流量时间段报表.cpt&__filename__=新ETC出口车型交通流量时间段报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
