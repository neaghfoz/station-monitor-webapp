...
<script>
  ...
  export default {
    name: 'report.etc.sx_rpt_etc_003',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/etc/sx_rpt_ETC_003_01_新ETC出口车型通行费时间段报表.cpt&__filename__=新ETC出口车型通行费时间段报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
