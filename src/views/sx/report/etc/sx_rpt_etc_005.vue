...
<script>
  ...
  export default {
    name: 'report.etc.sx_rpt_etc_005',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/etc/sx_rpt_ETC_005_01_新ETC出口交通费报表.cpt&__filename__=新ETC出口交通费报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
