...
<script>
  ...
  export default {
    name: 'report.etc.sx_rpt_etc_006',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/etc/sx_rpt_ETC_006_01_新ETC入口交通流量报表.cpt&__filename__=新ETC入口交通流量报表'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
