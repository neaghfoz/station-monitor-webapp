...
<script>
  ...
  export default {
    name: 'report.other.sx_rpt_other_002',
    ...
    methods: {
      async getData() {
        ...
        this.reportUrl = fineReportUtil.getUrl(
          '/ReportServer?reportlet=report/other/sx_rpt_other_001_01_交通部节假日数据表.cpt&_filename_=交通部节假日数据'+XEUtils.toDateString(new Date(), 'yyyyMMddmmddss'),
          this.queryParams);
