    ...
    <el-form v-loading="loading" :model="detailItem">
      ...
      <el-card class="box-card">
        ...
        <div>
          ...
          <el-button type="default" @click="changeFeeShow" size="middle" >{{feeShow ?  '收起' : '展开'}}</el-button>
        </div>
      </el-card>
      ...
      <el-card class="box-card">
        ...
        <div>
          ...
          <el-button type="default" @click="changeCardShow" size="middle" >{{cardShow ? '收起' : '展开'}}</el-button>
        </div>
      </el-card>
...
<script>
  ...
  import {detail, findDetailKeyList} from "../laneExListFailApi"
  ...
  export default {
    name: 'sx.search.list.laneExListFail.laneExListFailDetail',
    ...
    methods: {
      ...
      async goLaneOpLogView() {
        ...
        this.$router.push({
          path: '/search/list/laneExListFail/vehNotes/' + Date.parse(new Date()),
          query: {
