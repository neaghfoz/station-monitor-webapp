...
<script>
  ...
  import tableOption from "@/views/sx/systemRunningMonitor/dataquery/tollQuery/tableOption"
  import {getData, findPage} from "./tollQueryApi"
  import moment from "moment"
  import chartOption from "@/views/sx/systemRunningMonitor/dataquery/tollQuery/chartOption"
  import tiSysOrg from "@/views/pro/common/tiElement/tiSysOrg/tiSysOrg";
  import dictUtils from 'ecip-web/utils/dictUtils';

  export default {
    name: "systemRunningMonitor.dataquery.tollQuery.vue",
    mixins: [...mixin],
