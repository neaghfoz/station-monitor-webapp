...
<script>
  ...
  import tableOption from "@/views/sx/systemRunningMonitor/realtimemonitor/tableOption"
  import {getData, findPage} from "./realtimeMonitorApi"
  import moment from "moment"
  import chartOption from "@/views/sx/systemRunningMonitor/realtimemonitor/chartOption"
  import tiSysOrg from "@/views/pro/common/tiElement/tiSysOrg/tiSysOrg";
  import dictUtils from 'ecip-web/utils/dictUtils';

  export default {
    name: "systemRunningMonitor.datamonitor.realtimeMonitor.vue",
    mixins: [...mixin],
