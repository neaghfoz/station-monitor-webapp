    ...
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <el-row>
          ...
          <el-form-item>
            <el-button v-permission="['paper:findPage']" type="primary" @click="getData">查询</el-button>
      ...
      <div class="box">
        ...
        >
          ...
          <template v-slot:toolbar_buttons>
            <el-button type="primary" @click="instore()" v-permission="['paper:create']">纸券录入</el-button>
            <el-button type="primary" @click="cancel()" v-permission="['paper:cancel']">纸券核销</el-button>
            <el-button type="danger" @click="del()" v-permission="['paper:delete']">删除</el-button>
...
import { findPage } from './paperApi'
import TiSelect from '@/views/pro/common/tiElement/tiSelect/tiSelect'
import tiSysOrg from '@/views/pro/common/tiElement/tiSysOrg/tiSysOrg'
import TiExportExcel from '@/views/pro/common/tiElement/tiExport/tiExportExcel'
import instoreView from './components/paperInstoreView'
import cancelView from './components/paperCancelView'
import deleteView from './components/paperDeleteView'
    ...
    return {
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '所属站', field: 'stationOrg.fullName', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '车道', field: 'laneNo', minWidth: 120, showOverflow: true, align: 'center' },
    ...
    async cancel() {
      ...
      const result = this.tableData.selections.every((x) => {
        if (x.tagNo === 7 || x.tagNo === 0) {
          msg = '有部分纸券未被使用，不允许进行核销'
          return false
        }

        if (x.tagNo === 2) {
          msg = '有部分纸券已核销，不允许重复核销'
          return false
        }
