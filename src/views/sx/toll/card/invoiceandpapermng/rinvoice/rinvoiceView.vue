    ...
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <el-row>
          ...
          >
            <ti-select
              v-model="queryParams.invTypeStr"
              placeholder="请选择"
          ...
          <el-form-item>
            <el-button v-permission="['rationInvoice:findPage']" type="primary" @click="getData">查询</el-button>
      ...
      <div class="box">
        ...
        >
          ...
          <template v-slot:toolbar_buttons>
            <el-button type="primary" @click="instore()" v-permission="['rationInvoice:create']">定额发票录入</el-button>
            <el-button type="primary" @click="cancel()" v-permission="['rationInvoice:cancel']">定额发票核销</el-button>
            <el-button type="danger" @click="del()" v-permission="['rationInvoice:delete']">定额发票删除</el-button>
...
import { findPage } from './rinvoiceApi'
import TiSelect from '@/views/pro/common/tiElement/tiSelect/tiSelect'
import tiSysOrg from '@/views/pro/common/tiElement/tiSysOrg/tiSysOrg'
import TiExportExcel from '@/views/pro/common/tiElement/tiExport/tiExportExcel'
import instoreView from './components/rinvoiceInstoreView'
import cancelView from './components/rinvoiceCancelView'
import deleteView from './components/rinvoiceDeleteView'

export default {
  name: 'RinvoiceSaveListView',
  components: { TiExportExcel, TiSelect, tiSysOrg, instoreView, cancelView, deleteView },
  mixins: [...mixin],
  data() {
    return {
      importVisible: false,
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '类型', field: 'invTypeText', minWidth: 100, showOverflow: true, align: 'center' },
          { title: '定额发票面额', field: 'invMoneyText', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '定额发票起始号', field: 'invStartNo', minWidth: 120, showOverflow: true, align: 'center' },
          { title: '定额发票终止号', field: 'invEndNo', minWidth: 150, showOverflow: true, align: 'center' },
          { title: '定额发票数量', field: 'invCount', minWidth: 120, showOverflow: true, align: 'center' },
