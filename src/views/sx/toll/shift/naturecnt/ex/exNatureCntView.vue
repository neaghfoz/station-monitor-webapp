    ...
    <div class="search-form">
      <el-form ref="searchForm" :model="queryParams" inline :label-width="'100px'">
        <el-row>
          ...
          <el-form-item>
            <el-button v-permission="['stationExCount:findPage']" type="primary" @click="submit">查询</el-button>
    ...
    return {
      ...
      tableData: {
        ...
        tableColumns: [
          ...
          { title: '纸券成功交易额', field: 'paperSuccessFeeText', minWidth: 120, showOverflow: true, align: 'right' },
          { title: '纸券失败交易额', field: 'paperFailFeeText', minWidth: 120, showOverflow: true, align: 'right' },
