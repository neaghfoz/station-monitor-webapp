<script src="../shiftRegMainRecordApi.js"></script>
<template>
        ...
        <el-col :span="6">
          <el-form-item label="登记类型"  prop="userMarkNo"
            ...
            <ti-select v-model="shiftRegMainRecord.userMarkNo" dict-type="tibms_toll_userMarkNo" @change="userMarkNoChange()"
                       :disabled="shiftRegMainRecord.linkID != '' || process == 2"/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
        ...
        <el-col :span="6">
          <el-form-item label="车道号"  prop="laneNo"
            ...
            <el-select v-model="shiftRegMainRecord.laneNo"  filterable  placeholder="请选择" @change="initModal()"
                       :disabled="shiftRegMainRecord.linkID != '' || process == 2 || laneManageMode == 0 || laneNoDisabled">
              <el-option
      ...
      <el-row >
        ...
        <el-col :span="6">
          <el-form-item label="操作员"  prop="laneOperatorID"
            ...
            <el-select v-model="shiftRegMainRecord.laneOperatorID"  filterable  placeholder="请选择" @change="initModal()"
                       :disabled="shiftRegMainRecord.linkID != '' || process == 2">
              <el-option
      ...
      <el-row
        ...
        <el-col :span="6" v-if="process == 1">
          <el-form-item label="备用金" prop="spareMoneyForWork">
            <el-input type="text" maxlength="8" v-model="shiftRegMainRecord.spareMoneyForWork"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6" v-if="process == 2">
          <el-form-item label="备用金" prop="spareMoney">
            <el-input type="text" maxlength="8" v-model="shiftRegMainRecord.spareMoney"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="通行费" prop="txMoney">
            <el-input type="text" maxlength="10" v-model="shiftRegMainRecord.txMoney" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <!--<el-col :span="6">
          <el-form-item label="pos金额" prop="posMoney">
            <el-input type="text" maxlength="10" v-model="shiftRegMainRecord.posMoney" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="工本费" prop="gongBenFei">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.gongBenFei" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="不找赎"  prop="buZhaoShu">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.buZhaoShu" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="其他"  prop="other">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.other" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
-->
      </el-row>
      <!--<el-row >
        <el-col :span="6">
          <el-form-item label="备用金" prop="spareMoney">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.spareMoney" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="公司二维码" prop="gongSiErWeiMa">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.gongSiErWeiMa" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="港币" prop="gangBi">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.gangBi" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="假币" prop="jiaBi">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.jiaBi" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row >
        <el-col :span="6">
          <el-form-item label="卡赔款" prop="kaPeiKuan">
            <el-input type="text" maxlength="9" v-model="shiftRegMainRecord.kaPeiKuan" @input="checkTotalMoney()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="钱袋号" prop="moneyBagNumber">
            <el-input type="text" maxlength="25" v-model="shiftRegMainRecord.moneyBagNumber"></el-input>
          </el-form-item>
        </el-col>
      </el-row>-->
      </div>
      ...
      <el-row >
        <el-col :span="6">
          <el-form-item label="纸券数量" prop="paperCount">
            <el-input type="text" maxlength="5" v-model="shiftRegMainRecord.paperCount"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="空白票" prop="blankInvCount">
            <el-input type="text" maxlength="5" v-model="shiftRegMainRecord.blankInvCount"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="重打票" prop="retakeInvCount">
            <el-input type="text" maxlength="5" v-model="shiftRegMainRecord.retakeInvCount"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      </div>
        ...
        <el-col :span="10" class="row-border" style="width: 41%;" v-show="(shiftRegMainRecord.userMarkNo != ''
          ...
          <el-row class="bg-gray">
            ...
            <el-col :span="5" class="row-border">
              ...
              <el-button type="primary" class="tableButton" @click="selectCardUnitNoInList()">流水查找</el-button>
            </el-col>
          </el-row>
...
<!--               <el-input type="text" maxlength="10" v-model="item.cardUnitNo"></el-input>-->
<!--              <ti-select v-model="item.cardUnitNo" data- url="/api/v1/toll/cardUnit/cardUnits" pstyle ="width:100%;" :props="{key:'unitNo',value:'unitNo',label:'unitNo'}"/>-->
            ...
            <el-col :span="5" class="row-border" :class="process == 1?'elColEdit':''">
              <el-input type="number" @input="checkCardCount(index)" :disabled="process == 2" v-model="item.cpcCardCountForWork"></el-input>
            </el-col>
            <el-col :span="5" class="row-border" :class="process == 2?'elColEdit':''">
              <el-input type="number" @input="checkCardCount(index)" :disabled="process == 1" v-model="item.cpcCardCountOffWork"></el-input>
            </el-col>
          ...
          <div v-show="process == 2">
            <el-form-item label="还卡数" prop="returnCardCnt" style="margin-top: 15px;width: 80%;">
              <el-input type="text" maxlength="5" v-model="shiftRegMainRecord.returnCardCnt"></el-input>
            </el-form-item>
          <div class="page-header">
            <span>坏卡</span>
          ...
          <div style="padding: 5px 5px;border: 1px solid #eee;" v-show="(shiftRegMainRecord.userMarkNo != ''
            ...
            <table class="table" id="invCodeTable">
                ...
                <td style="width:150px;max-width: 150px;">
                  <div class="form-group">
                    <div class="col-md-12 text-center" style="background: #dddddd;">
                      ...
                      <el-button type="primary" class="tableButton" @click="selectInvCodeInList()">流水查找</el-button>
                    </div>
                  </div>
                </td>
              </tr>
              ...
              <tr v-for="(item, index) in shiftRegMainRecord.shiftInvDetailList">
                ...
                <td style="min-width:160px" class="elColEdit">
                  <el-input type="number" @input="sumShiftInvDetailInvCount(index)" @blur="confirmInvCount(index)" v-model="item.invStartNo" maxlength="9"></el-input>
                </td>
                <td style="min-width:160px" class="elColEdit" >
                  <el-input type="number" @input="sumShiftInvDetailInvCount(index)" @blur="confirmInvCount(index)" v-model="item.invEndNo" maxlength="9"></el-input>
                </td>
                ...
                <td style="width:150px;max-width: 150px;">
                  <div class="form-group">
                    <div class="col-md-12 text-center" style="background: #dddddd;">
                      ...
                      <el-button type="primary" class="tableButton" @click="selectBadInvInList(true)">流水查找</el-button>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <!--<div style="margin-top: 10px;padding: 5px 5px;border: 1px solid #eee;" v-show="(shiftRegMainRecord.userMarkNo != ''
            ...
            <table class="table" id="manualInvCodeTable">
              ...
              <tr v-for="(item, index) in shiftRegMainRecord.shiftSquadRationInvoiceList">
                ...
                <td>
                  <el-input type="number"  v-model="item.invStartNo" maxlength="9" @input="sumManualInvCount(index)"></el-input>
                </td>
                <td>
                  <el-input type="number"  v-model="item.invEndNo" maxlength="9" @input="sumManualInvCount(index)"></el-input>
                </td>
                <td>
      ...
      <el-row style="text-align: center;margin-top: 10px;">
        ...
        <el-button type="primary" v-permission="['shiftRegMainRecord:goBack']" @click="goBack(1)"
                v-show="process == 2" id="goBackBtn">回退</el-button>
       <!-- <el-button type="primary" v-permission="['shiftRegMainRecord:create']"
                   :loading="saveLoading" @click="save_1(4)"
                   v-show="process == 1 || (process == 2 && status == 3)">保存</el-button>-->
        <el-button type="primary" v-permission="['shiftRegMainRecord:create']"
                   :loading="saveLoading" @click="save_1(2)"
                   v-show="process == 1">下一步</el-button>
        <el-button type="primary" v-permission="['shiftRegMainRecord:create']"
                   :loading="saveLoading" @click="save_1(2)"
                   v-show="process == 2 && status == 3">保存</el-button>
        <el-button type="primary" v-permission="['shiftRegMainRecord:create']"
                   :loading="saveLoading" @click="save_1(3)"
                   v-show="process == 1 ">保存并新增</el-button>
      </el-row>
    </el-form>
...
export default {
  ...
  created() {
    ...
    this.init();
    let that = this
    api.findStationByAuth(4).then(res => {
      if(res.code == 200){
    ...
    async save_1(buttonType){
      ...
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          console.log(moment(this.shiftRegMainRecord.squadDateStr).format('YYYY-MM-DD'))
          //工班结算校验
      ...
      switch (parseInt(that.buttonType)) {
        ...
        case 3:
          that.$alert("保存交班登记成功！",'提示',{
            confirmButtonText: "确定",
            callback: action => {
              that.cardBoxOpType = 1 // 卡单元操作类型：1：新增；0：删除
              that.buttonType = -1 // 按钮类型：1：回退；2：提交；3：提交并新增；4：保存；5：取消；
              that.process = 1 // 流程节点：1：上班；2：下班； 默认进来是上班状态
              that.status = 1 // 业务状态：1：上班草稿；2：上班提交；3：下班草稿；4：下班提交；
              that.operationTyp = 1 // 操作类型：1：新增；2：修改；
              that.loading = false
              that.saveLoading = false
              that.initModal()
              that.shiftRegMainRecord.laneOperatorID = ''
